 ...
 */
public class RecycleViewOrderWithPriceAdapter extends RecyclerView.Adapter<GuruHolder>{
    ...
    public RecycleViewOrderWithPriceAdapter(Context context, List<APIGuruData.ResponBean.DataBean> listGuru) {
